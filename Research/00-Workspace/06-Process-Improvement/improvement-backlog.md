...
| 候选 | 高 | stock.ts --announcements 默认单页 20 条且不循环翻页，--days 730 长窗口截断早期重… | .trae/scripts/stock-data/stock.ts | 5 | stock-announcements-pagination-limit |
...
| 候选 | 高 | 50项投资决策清单 AUTO 扫描器对本任务发生金额单位误读：第29/31项将归母净利『5.63亿』误判为增长『563.… | .trae/skills/research-quality-gate/scripts/investment-checklist-auto.ts | 2 | investment-checklist-auto-unit-misread |
...
| 候选 | 中 | 奥浦迈财报采集再次因 cninfo(PDF/公告 API)HTTP403 阻断 stock.ts --financial… | .trae/commands/deep-dive.md | 3 | cninfo-http403-forcing-mirror-downgrade |
...
| 观察 | 中 | quality-screen --file 报告模式在本任务对 deep-read(而非公司笔记)做筛查时误抓 2023… | .trae/scripts/quality-gate/quality-screen.ts | 1 | quality-screen-file-mode-parses-wrong-period |
